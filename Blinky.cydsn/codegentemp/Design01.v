...
module top ;
	...
	wire [0:0] tmpFB_0__GreendLight_net;
	wire [0:0] tmpIO_0__GreendLight_net;
	electrical [0:0] tmpSIOVREF__GreendLight_net;
	...
	cy_mxs40_gpio_v1_0
		...
		GreendLight
		 (.oe({1'b1}),
		  .y({Net_3}),
		  .fb({tmpFB_0__GreendLight_net[0:0]}),
		  .io({tmpIO_0__GreendLight_net[0:0]}),
		  .siovref(tmpSIOVREF__GreendLight_net));
